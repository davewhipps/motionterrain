...
class ViewController: UIViewController {
  ...
  private var model: ModelType = .lavatedSimple
...
enum DefaultConstants {
  ...
  static let maxResults = 1 // Was 3
  static let scoreThreshold: Float = 0.05 // was 0.2
  static let model: ModelType = .lavatedSimple
}
...
enum ModelType: CaseIterable {
  ...
  var modelFileInfo: FileInfo {
    switch self {
    case .lavatedSimple:
      return FileInfo("motionterrain_simple", "tflite")
    case .efficientnetLite0:
